...
void main() {
  ...
  test('check is render function with object', () async {
    ...
    Utils.render(entries, rteKeys: rteString, optionCallback: callback);
  });
  ...
  test('check is render function with list', () async {
    ...
    final entries = json['entries'];
    var callback = OptionCallback();
    Utils.render(entries, rteKeys: [], optionCallback: callback);
  });
  ...
  test('test on embedded assets', () {
    ...
    Utils.getEmbeddedObjects(embedded_asset_string);
  });
}
